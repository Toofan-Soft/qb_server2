...
class GeneratePaperExam
{

    public static function execute($request)
    {
        $examData = $this->retrievePaperExamData($request);
    ...
    private static function retrievePaperExamData($request)
    {
        $examData = [
            'exam_type' => 'real_exam',
    ...
    private static function generatePaperExamQuestions(){

    }
    private static function selectPaperExamQuestionsChoicesCombination(){
