...
class GenerateOnlineExam
{
    ...
    {
        $examData = $this->retrieveOnlineExamData($request);
    ...
    private static function retrieveOnlineExamData($request)
    {
        $examData = [
            'exam_type' => 'real_exam',
    ...
    private static function generateOnlineExamQuestions(){

    }
    private static function selectOnlineExamQuestionsChoicesCombination(){
