...
// $formsCount, $formConfigurationMethodId, $questionsTypes, $topicsIds
    ...
    public static function updateStudentQuestionUsageAnswer($formId, $questionId, $answer){

    }

    public static function updateGuestQuestionUsageAnswer($examId, $questionId, $answer){
